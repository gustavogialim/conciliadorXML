...
$cppBinaryPathx86 = Join-Path $packagePath "nativeBinaries\x86\msvcr110.dll"
$cppBinaryPathx64 = Join-Path $packagePath "nativeBinaries\x64\msvcr110.dll"
...
$cppLinkx86 = $folderx86.ProjectItems | where Name -eq "msvcr110.dll"
if (!$cppLinkx86)
{
...
$cppLinkx64 = $folderx64.ProjectItems | where Name -eq "msvcr110.dll"
if (!$cppLinkx64)
{
